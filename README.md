...
![The Collection Screenshot](./Project1-Collection/assets/screenshot.png)
...
![To-Do List Screenshot](./Project2-ToDoList/screenshot1.png)
...
- Add **live demo links** (via GitHub Pages, Netlify, or Vercel)  
- Add **badges** (tech stack, status, etc.)  
- Keep project naming consistent (e.g. `the-collection`, `todo-list`)  